...
save(consensus.result, file="consensus.result.rda")
refine.result = refine_cl(new.consensus.result$cl, co.ratio=co.ratio.min, tol.th=0.005, confusion.th=0.8, min.cells=4)
